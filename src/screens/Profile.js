...
export const Profile = ({}) => {
  ...
  return (
    <SafeAreaView style={styles.profileContainer}>
        <View style={styles.profileInformation}>
          <View style={styles.profileInformation_firstLine}>
            ...
            <View style={styles.personalInformation}>
              <ProfileImage image={DATA.podilePhoto} size={95}/>
              <Text style={styles.name}>{DATA.name}</Text>
              <Text style={styles.link}>{DATA.link}</Text>
              <Text style={styles.countryCity}>{DATA.country}, {DATA.city}</Text>
              <Text style={styles.workpalce}>Место работы: {DATA.workpalce}</Text>
            </View>
        ...
        <View style={{ paddingHorizontal: 16, borderTopWidth: 1, borderColor: Colors.purple_06}}/>
        ...
        <View style={{width: "100%", height: 45, backgroundColor: Colors.purple_1 }}></View>
